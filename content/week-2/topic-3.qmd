...
*Alternatively, is the individual cancelled_tidy file: [phs_cancelled_tidy.Rda](/documents/week-2/phs_cancelled_tidy.Rda) Note: To load the data, find the file on your computer, double click to open (select RStudio if prompted, and select "yes" to loading into your Global Environment).*
