...
![](images/week02-topic03-data-cowboy.png){fig-alt="Data cowboy"}
...
![](images/week02-topic03-dplyr-filter.jpg){fig-alt="dplyr filter cartoon"}

![](images/week02-topic03-dplyr-mutate.png){fig-alt="dplyr mutate campaign"}
...
If you want to recreate the following session on your own computer, you can download the **cancelled_operations** project folder here: [cancelled_operations.zip](../documents/week-2/cancelled_operations_2.zip)
...
*Alternatively, here is the individual cancelled_messy file: [phs_cancelled_messy.Rda](../documents/week-2/phs_cancelled_messy.Rda). Note: To load the data, find the file on your computer, double click to open (select RStudio if prompted, and select "yes" to loading into your Global Environment).*

[![](images/week02-topic03-health-data-science-explore-data.png){fig-alt="Explore data"}](https://media.ed.ac.uk/playlist/dedicated/165686341/0_n8z6wzy7/0_0x81oy5g)

### Tidy Data

Watch the following video to learn about some of the functions for reshaping your data so that you can get it into a format which makes it easy to plot. If you want to recreate the following session on your own computer, use the cancelled_operations folder that you [downloaded before](#explore-data).

[![](images/week02-topic03-health-data-science-tidy-data-video.png){fig-alt="Tidy data video"}](https://media.ed.ac.uk/playlist/dedicated/165686341/0_n8z6wzy7/1_6lvj81qx)

Download the video transcript link [here](../documents/week-2/Tidying%20Data.docx)
...
![](images/week02-topic03-tidydata-1.jpg){fig-alt="Tidy data cartoon"}

![](images/week02-topic03-tidydata-2.jpg){fig-alt="Tidy data cartoon"}

![](images/week02-topic03-tidydata-3.jpg){fig-alt="Tidy data cartoon"}

![](images/week02-topic03-tidydata-6-jpg.jpg){fig-alt="Tidy data cartoon"}

![](images/week02-topic03-tidydata-7.jpg){fig-alt="Tidy data cartoon"}

[artwork by Allison Horst](https://twitter.com/allison_horst?lang=en)

### Prepare Data

In this video we're going to take a first look at visualising our data as a way of exploring it and looking for outliers, or mistakes. If you want to recreate the following session on your own computer, use the cancelled_operation folder that you [downloaded before](#explore-data).

[![](images/week02-topic03-prepare-data-video.png){fig-alt="Prepare data video"}](https://media.ed.ac.uk/playlist/dedicated/165686341/0_n8z6wzy7/0_2w3an1sj)

Download the video transcript link [here](/documents/week-2/Preparing%20Data.docx)
...
![](images/week02-topic03-gbd-output.png){fig-alt="GBD output"}
...
![](images/week02-topic03-gbd-output2.png){fig-alt="GBD output 2"}
...
![](images/week02-topic03-gbd-output3.png){fig-alt="GBD output"}
...
![](images/week02-topic03-gbd-output4.png){fig-alt="GBD output"}
...
![](images/week02-topic03-gbd-output5.png){fig-alt="GBD output"}
...
![](images/week02-topic03-lubridate.png){fig-alt="Lubridate cartoon"}

![](images/week02-topic03-lubridate-ymd.png){fig-alt="Lubridate cartoon"}
...
![](images/week02-topic03-janitor-clean-names.png){fig-alt="Janitor clean names cartoon"}
