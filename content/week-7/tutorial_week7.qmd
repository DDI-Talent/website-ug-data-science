...
The Public Health Scotland data sets that we'll be using for the assessment can be found here: <https://www.opendata.nhs.scot/dataset/prescriptions-in-the-community>

The Scottish Census can be found here: <https://www.scotlandscensus.gov.uk/>

In the exercises today you'll get to work with data from both sources.
