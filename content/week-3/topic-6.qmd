...
<a href="files/wrangling_and_summarising.Rmd" download> <button class="btn btn-danger"> <i class="fa fa-save"></i> Download Wrangling and Summarising RMarkdown </button> </a>

<a href="files/global_burden_disease_long.csv" download> <button class="btn btn-danger"> <i class="fa fa-save"></i> Download the wrangling dataset </button> </a>

### **Plotting**

<a href="files/plotting.Rmd" download> <button class="btn btn-danger"> <i class="fa fa-save"></i> Download the plotting RMarkdown </button> </a>
