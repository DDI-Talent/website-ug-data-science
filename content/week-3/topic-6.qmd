...
Wrangling R Markdown document:

<a href="documents/week-3/wrangling_and_summarising.Rmd" download> <button class="btn btn-danger"> <i class="fa fa-save"></i> Download wrangling_and_sumarising.Rmd file </button> </a>

Wrangling data:

### **Plotting**

Plotting R Markdown document:

<a href="documents/week-3/plotting.Rmd" download> <button class="btn btn-danger"> <i class="fa fa-save"></i> Download plotting.Rmd </button> </a>
