...
=======
**************************************************
>>>>>>> 8f1006f21341724ca705378d06ead42abae1c1af
...
With a clone we copy the remote repo to our own machine, and our locla copy maintains a "hard link" to the original.
...
Doing this means we still make a copy of the repo, but instead of copying to out local machine, we can create our own copy in our own GitHub account.
...
Note that anyone can fork any public repo... you can fork the `ggplot2` repo if you like!

![The __fork__ button in the GutHub navbar. Located just above the green __code-- button we use to __clone__ a repo.](images/git-r/12_gh_forking.png)
