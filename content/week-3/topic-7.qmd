---
title: 'Topic 7: Introduction to using Git and GitHub with RStudio'
format: html
...
![Github Repositories tab](images/week03-topic07-01_gh_repos-tab.png){#fig-repos-tab}

-   Click the big green button to create a new repository.

![Click "New" to begin creating a repo](images/week03-topic07-02_gh_new-repo-button.png){#fig-new-repo-button width="35%"}
...
![Naming your repo. Don't forget to give a description.](images/week03-topic07-03_gh_name-repo.png){#fig-name-repo}
...
![Add a readme - whatever you wrote in your description abouve will be placed here automatically. Also, select the `.gitignore` file appropriate for `R`.](images/week03-topic07-04_gh_init-repo.png){#fig-init-repo}

And click the big green button at the bottom.

![Click "Create repository"](images/week03-topic07-05_gh_create-repo.png){#fig-create-repo}
...
![Copy the repo URL after clicking the "Code" button.](images/week03-topic07-06_gh_get-clone-link.png){#fig-get-clone-link}
...
![Paste the repo URL nto your terminal. The repo will be cloned in whixhever directory you are in when you do this, so make sure you are in the directory you want to be in!](images/week03-topic07-01_term_create-local-repo-dir.png){#fig-create-local-repo-dir}
...
![Pressing enter will instruct Git to download the repo.](images/week03-topic07-02_term_clone-repo.png){#fig-clone-repo}
...
![The `Project` drop-down menu can be used for creaing new projects.](images/week03-topic07-01_rs_new-proj.png){#fig-new-proj}

-   In the menu that opens, select **`Existing Directory`**.

![We already have a project directory. It just has no project in it. So select "Existing Directory" for creating your project.](images/week03-topic07-02_rs_existing-dir.png){#fig-existing-dir}
...
![Use the browse button to find the locaton of your cloned your repo.](images/week03-topic07-03_rs_create-project.png){#fig-git-tracked-project}
...
![Your project already contains the files you used to initialize it in GitHub](images/week03-topic07-04_rs_git-tracked-project.png){#fig-git-tracked}

### RStudio-Git integration

Now that we are using Git with RStudio, we should be able to find a **Git pane** (@fig-git-pane). By default, I think it appear in the top right panel of Rstudio. It may be somewhere else, so if you don't see it, check the other panels
...
One you have found the Git pane, you should see two files listed with some yellow squares ![yellow question mark](images/week03-topic07-rs-git-icon-untracked.png) and a check-box next to them.
...
In this case we do want to track both files, so tick **both check-boxes** and the ![untracked yellow question mark](images/week03-topic07-rs-git-icon-untracked.png) should become green squares with `A` inside ![added green A](images/week03-topic07-rs-git-icon-added.png).

![The Git pane only appears if you are in a Git tracked directory. So you may have never seen it before. It can usually be found in the top right panel of RStudio.](images/week03-topic07-05_rs_git-pane.png){#fig-git-pane}
...
![Add a descriptive commit message. More detail is good here, especially as your project matures. It will allow you to make sense of historical commits, like if you... need to find that time... you did that thing...](images/week03-topic07-06_rs_first-commit.png){#fig-first-commit}

-   You will then be given a short summary of the commit
-   Click close
-   Check out the Git pane again - it should now be empty?

![If your commit succeeds you will be given a short summary. If it fails, you may need to call in some support.](images/week03-topic07-08_rs_commit-success.png){#fig-commit-success width="60%"}
...
![`.DS_Store` files often crop up in repos. They are Mac only files and they are a nuisance for your repo. Add them to your `.gitignore` **every time**. Windows has a similar file (`thumbs.db`), but it seems to be less pervasive.](images/week03-topic07-09_rs_gitignore.png){#fig-git-ignore width="50%"}

### Commit cyle

Once again, take a look at the Git pane. We should see that the `.gitignore` file has appeared again. This time instead of ![untracked yellow question mark](images/week03-topic07-rs-git-icon-untracked.png), it has a blue square with `M` inside ![modified blue M](images/week03-topic07-rs-git-icon-modified.png) inside.
...
![Get used to the Git commit cycle. `Work > Save > Commit > back to work`. And do it often. but note there is one step that we have covered not shown here. Can you remember?](images/week03-topic07-01_git_commit-cycle.png){#fig-commit-cycle}
...
![Another commit message. Do not use the same commit message as shown here. A commit message needs to describe the changes that happened. What might be more meaningful here?](images/week03-topic07-07_rs_first-commit-and-push.png){#fig-commit-and-push}

![The summary you see after a push tells you that your have pushed the changes on `HEAD` (your local version) to `main` the remote version.](images/week03-topic07-10_rs_push-success.png){#fig-push-success width="60%"}
...
![Commit cycle with the added `Push` step](images/week03-topic07-02_git_commit-cycle-with-push.png)
...
![The **fork** button in the GutHub navbar. Located just above the green **code** button we use to **clone** a repo.](images/week03-topic07-12_gh_forking.png){#fig-forking}
...
![Choose a name for the fork. the same name as the original repo is fine.](images/week03-topic07-13_gh_naming-fork.png){#fig-naming-fork}
...
![Green "create fork button". Click it!](images/week03-topic07-14_gh_fork-green-button.png){#fig-green-fork-button}
...
![A possible setup for your work, and the workflow for a pair-programming session.](images/week03-topic07-tutorial-repo-setup.png){#fig-dir-str}
