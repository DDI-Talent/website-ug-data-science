...
![Add a readme - whatever you wrote in your description above will be placed here automatically. Also, select the `.gitignore` file appropriate for `R`.](images/week03-topic07-04_gh_init-repo.png){#fig-init-repo}
...
![Paste the repo URL into your terminal. The repo will be cloned in whichever directory you are in when you do this, so make sure you are in the directory you want to be in!](images/week03-topic07-01_term_create-local-repo-dir.png){#fig-create-local-repo-dir}
...
![Use the browse button to find the location of your cloned your repo.](images/week03-topic07-03_rs_create-project.png){#fig-git-tracked-project}
