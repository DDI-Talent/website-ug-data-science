...
There is a [super useful graphics cheat sheet](files/visualization-principles.pdf) by Marc Vandemeulebroecke, Mark Baillie, Alison Margolskee, and Baldur Magnusson, which you can use as a reference for some of the different considerations in creating an effective data visualisation.
