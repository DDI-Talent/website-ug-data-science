...
This [infographic](files/Be_fruitful_and_multiply.pdf) published in the British Medical Journal describes factors influencing birth rates over time in China, with contextual annotations such as the date of the introduction of the two-child policy, the Chinese zodiac year, and annual celebrations. The infographic displays text, a combination of line and area graphs and a selection of pie charts. There is a good mix between white and colour, the font size is appropriate, and the text is well-placed.
