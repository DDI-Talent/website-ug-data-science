...
Words in bold are explained somewhere else in this glossary.
...
__Fork__  
A personal copy of someone else's __repository__, typically used to contribute or start independent development.
...
__Stage__  
The process of adding changed files to the __staging area__ to include them in a __commit__.
