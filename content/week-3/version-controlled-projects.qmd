...
![We already have a porject directory. It jsut has no prject in it. So select "Existing Directory" for creating your project.](images/git-r/02_rs_existing-dir.png){#fig-create-project}
...
![When you (or a collaborator) `Pulls`, you will see a short summary of what exactly you have pulled.](images/git-r/11_rs_pull-success.png){#fig-pull-success}
## Final set-up tips
