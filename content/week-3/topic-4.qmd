...
Here are Dr Tyner's [slides](files/Dr_Tyner-slides.pdf).
...
Here is the [R script](files/Data_visualisation_and_storytelling_subtopic_plots.R) and the [transcript of the presentation](files/Data_visualisation_demonstration_transcript.pdf).
