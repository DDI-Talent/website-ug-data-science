...
# because we evaluate some of those cells for the quatro website:

print("testing, running package checks")
if(!require(rmarkdown)){
    install.packages("rmarkdown")
    library(rmarkdown)
    print("testing, rmarkdown")
...
![](images/week03-topic04-cartoon-visual-data-exploration.png){fig-align="center" width="631"}
...
![](images/week03-topic04-environment.png){fig-align="center"}
...
![](images/week03-topic04-ggplot2-elements.png){fig-align="center"}
...
![](images/week03-topic04-scatterplot-with-colours.png){fig-align="center"}
...
![](images/week03-topic04-barplot.png){fig-align="center"}
...
![](images/week03-topic04-histogram.png){fig-align="center"}
...
![](images/week03-topic04-boxplot-explained.png) ![](images/week03-topic04-boxplots.png)
...
![](images/week03-topic04-practice-plot1.png){fig-align="center"}

**Hint**: You will need to use the dplyr::mutate() function, and some functions from the `lubridate` package!

### **Plot 2**

![](images/week03-topic04-practice-plot2.png){fig-align="center"}
...
[![](images/week03-topic04-optional-topic4.png)](https://media.ed.ac.uk/media/1_cdi4lera)
...
[![](images/week03-topic04-optional-topic4-2.png)](https://media.ed.ac.uk/media/1_nnumebbf)
