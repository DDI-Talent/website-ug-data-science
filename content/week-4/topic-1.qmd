...
<a href="/documents/week-4/factors.Rmd" download> <button class="btn btn-danger"> <i class="fa fa-save"></i> Download factors.Rmd </button> </a>

<a href="/documents/week-4/melanoma_data.csv" download> <button class="btn btn-danger"> <i class="fa fa-save"></i> Download the melanoma dataset </button> </a>
...
![](images/week04-topic01-xy.png){fig-align="center" width="312"}
...
![](images/full-week04-topic01-full-join.gif){fig-align="center"}

```{r}
full_join(x, y, by = "id")
```

![](images/week04-topic01-full-join.png){fig-align="center"}

### **I want to keep all data from *x* and only matching data from *y***

![](images/week04-topic01-left-join.gif){fig-align="center"}
...
![](images/week04-topic01-left-join.png){fig-align="center"}
...
![](images/week04-topic01-inner-join.gif){fig-align="center"}
...
![](images/week04-topic01-innerjoin.png){fig-align="center"}

You can also think of joins using Venn diagrams:

![](images/week04-topic01-venn-diagrams.png){fig-align="center" width="497"}
...
![](images/week04-topic01-rdata-example.png){fig-align="center"}
