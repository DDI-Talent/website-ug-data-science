...
![](images/paste-500B9327.png){fig-align="center"}
...
![](images/paste-F1D6DB18.png){fig-align="center"}
...
![](images/paste-1B9B962C.png){fig-align="center" width="225"}
...
![](images/paste-1F863529.png){fig-align="center" width="274"}
...
CODE OF COMBINED_EXAMPLE.RMD IS HERE!
PDF is here
...
download_link(
  link = "/documents/week-4/Combined-Example-W4.3.pdf",  # Path to your PDF file
  button_label = "Download the census report (PDF)",
  button_type = "primary",  # You can change the color style (e.g., "primary", "success", "info")
  has_icon = TRUE,
  icon = "fa fa-file-pdf",  # Font Awesome icon for PDF
