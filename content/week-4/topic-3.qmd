...
![](images/paste-9302C4B7.png) Always use the **raw data**. If your data has come from a database or from a publicly updated data source, avoid the temptation of doing some quick and dirty data wrangling in Excel before importing into R. This would make your analysis less reproducible as you may not always remember exactly what steps you took during this initial phase and these steps would then need to be taken each time you wanted to repeat or carry out a similar operation. 

![](images/paste-F1D6DB18.png)
...
![](images/paste-D7565B55.png){width="427"}\
...
![](images/paste-1B9B962C.png){width="225"}
...
![](images/paste-1F863529.png){width="274"}
...
![](images/paste-C3ADDD87.png){width="237"}
...
![](images/paste-40587EA3.png){width="220"}
...
![](images/paste-3FCC498F.png){width="368"}
...
![](images/paste-A62454F5.png){width="500"}
...
![](images/paste-1E0B14AB.png){width="344"}
...
![](images/paste-46D94E8A.png){width="332"}
...
![](images/paste-8B474167.png){width="335"}
...
![](images/paste-E120CB6F.png){width="379"}
