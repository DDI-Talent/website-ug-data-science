...
![](images/easyread.svg){fig-align="center"}
...
![](images/week4.3.tidyverse.png){width="271"}\
...
In the example in this [Link](files/Combined_example.Rmd) you can see a simple R Markdown document without any narrative text added yet, just the YAML then a series of code chunks outlining the various stages in the data analysis process.
